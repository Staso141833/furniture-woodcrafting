    ...
    return (
        ...
        <div className="footer-nav">
          <ul className="nav-ul">
            ...
            <li className="nav-items"><Link to="home">About us</Link></li>
            <li className="nav-items"><Link to="/home">Contacts</Link></li>
          </ul>
        ...
        <div className="footer-copy-right">
          <p>
            INFERNO Copyright <i className="far fa-copyright"></i> 2023 Inferno - All rights reserved ||
            Designed By: S. Stiptsov
          </p>
        </div>
      </div>
    )
