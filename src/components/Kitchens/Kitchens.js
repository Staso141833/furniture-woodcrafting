  ...
  return (
    <section id="kitchens">
      ...
      <div className="pictures-kitchens">
        ...
        <div className="picture-kitchen">
          <img
            src="https://www.kitchendesigncentre.com/wp-content/uploads/2023/02/contemporary-open-plan-living.jpg"
            alt="furniture"
          />
        </div>
        ...
        <div className="picture-kitchen">
          <img
            src="https://www.wrenkitchens.com/blog/wp-content/uploads/2021/12/2022-kitchen-design-trends-dark-kitchen-scaled.jpg"
            alt="furniture"
          />
        </div>
      </div>
